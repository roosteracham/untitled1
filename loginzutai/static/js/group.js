...
function toServer(json) {
    /*console.log($('outProjectName').value +"#"+ $('outId').value,
        localStorage.getItem($('outProjectName').value +"#"+ $('outId').value),
        $('outProjectName').value +"#"+"configureName" + $('outId').value,
        localStorage.getItem($('outProjectName').value +"#"+"configureName" + $('outId').value));*/

    var data = {
        projectName : $('outProjectName').value,
        jsonData : json,
        outId : $('outId').value,
    ...
    jQuery.post( "/export", JSON.stringify(data), function () {
            //alert("success");
        }
    );
}
